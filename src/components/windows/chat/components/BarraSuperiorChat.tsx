        ...
        >
            ...
            <div className="flex items-center gap-0.5">
                <button
                    ...
                    className="flex h-9 w-10 items-center justify-center rounded-lg text-[#8f97a5] transition-colors hover:bg-white/[0.06] hover:text-[#eef2f8]"
                ...
                <button
                    ...
                    className="flex h-9 w-10 items-center justify-center rounded-lg text-[#9da4b0] transition-colors hover:bg-[#b42318] hover:text-white"
